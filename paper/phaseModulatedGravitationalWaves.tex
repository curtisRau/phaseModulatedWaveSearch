...
Recently, the Laser Interferometer Gravitational-Wave Observatory (LIGO) confirmed the first experimental evidence of gravitational waves. The discovered ripples in space-time by LIGO was a function of the inspiral of two black holes that eventually merged --- an even that consumed approximately 30 solar masses. It is believed that gravitational wave sources are actually fairly common in the universe and sources of continuous monochromatic (single frequency) gravitational radiation are predicted to exist --- at least sources with frequencies that persist over many periods \cite{}. Neutron stars have also been implicated as one of the prime sources of gravitational waves. These stars are expected to emit single frequency waves over long periods of time. Additionally, it has also been proposed that an appreciable fraction of detectable gravitational waves are binary neutron star systems --- two neutron starts orbiting around each other.
...
\begin{figure*}[ht]
\includegraphics[width = 0.5\linewidth]{denoise_3.jpg}
\caption{\label{fig:denoise_3} Denoising results}
\end{figure*}
