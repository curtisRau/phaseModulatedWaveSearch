...
\textbf{Curtis Rau}
Curtis was the most familiar with the topic and therefore performed the role of group leader identifying topics and problems of interest to be researched. He was also in charge of writing sections: "The Gustafson Algorithm", and "The Gustafson Algorithm as a Search Algorithm".  He also wrote the section "Implementation of the Gustafson Algorithm in C++" for another class.  He presented his part in the class presentation.
...
Sam researched and wrote the section on noise and error analysis, and wrote the results. He helped greatly in rewording problem sections through out the paper, and greatly expanded the discussion of all topics.  Sam played a major role in reviewing and editing others' sections.  He presented his work in class.  Sam also wrote the Matlab code for the noise removal.
