...
\textbf{Curtis Rau:}
Curtis was the most familiar with the topic and therefore performed the role of group leader identifying topics and problems of interest to be researched. He was also in charge of writing sections: "The Gustafson Algorithm", and "The Gustafson Algorithm as a Search Algorithm".  He also wrote the section "Implementation of the Gustafson Algorithm in C++" for another class, along with the C++ code.  He presented his part in the class presentation.
